...
public class GetImageListApi {
     ...
     * 获取图片列表
     *
     * @param url  结果Url 这个相当于是Json数据了，就是响应数据，只不过他是String格式的
     * @return
     */
...
//        String url = "https://graph.baidu.com/ajax/pcsimi?carousel=503&entrance=GENERAL&extUiData%5BisLogoShow%5D=1&inspire=general_pc&limit=30&next=2&render_type=card&session_id=16250747570487381669&sign=1265ce97cd54acd88139901733452612&tk=4caaa&tpl_from=pc";
       String url ="https://graph.baidu.com/ajax/pcsimi?carousel=503&entrance=GENERAL&extUiData%5BisLogoShow%5D=1&inspire=general_pc&limit=30&next=2&render_type=card&session_id=15819025703100062342&sign=121ade97cd54acd88139901741951600&tk=2040a&tpl_from=pc";
